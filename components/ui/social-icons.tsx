...
const socials = [
  {
    name: "Phone",
    href: "tel:+919686517442",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="size-[28px]">
  ...
  {
    name: "GitHub",
    href: "https://github.com/ChinmaySN",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="size-[28px]">
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/chinmaysn/",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="size-[28px]">
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/not_yet_decided_xd?igsh=OW1ocmdsOWFyZ3U1",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="size-[28px]">
    ...
    <div className="relative flex items-center gap-2 px-4 py-4 rounded-3xl bg-theme-tertiary border border-theme transition-colors duration-300">
      ...
      {socials.map((social, index) => (
        <a
          ...
          className="group relative flex items-center justify-center size-16 rounded-xl transition-colors duration-200"
        ...
        >
          ...
          <span
            className={`absolute -top-12 left-1/2 -translate-x-1/2 px-3 py-1.5 rounded-lg bg-white text-neutral-950 text-xs font-medium whitespace-nowrap transition-all duration-300 ease-out ${
